...
$assert(strpos($profileReviewsView, 'تأیید اصلاح مشخصات') !== false && strpos($profileReviewsView, 'مقایسه تغییرات') !== false, 'Dedicated management profile-review section is missing.');
