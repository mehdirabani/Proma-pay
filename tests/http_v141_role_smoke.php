...
$roles = [
    'admin' => [
        ...
        'routes' => ['dashboard', 'notifications', 'users', 'customers', 'contracts', 'installments', 'overdue', 'payments', 'review', 'legal', 'chat', 'calendar', 'file-manager', 'medals', 'plugins', 'settings'],
        'forbidden' => null,
    ],
    'operator' => [
