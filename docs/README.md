...
| `contracts/` | موتور قالب، ویرایشگر، نسخه‌بندی، profile چاپ و بازسازی اسناد قرارداد |
| `ui/` | معماری و قواعد رابط‌های تخصصی سامانه |
| `security/` | پاک‌سازی محتوا و کنترل‌های امنیتی قابلیت‌ها |
