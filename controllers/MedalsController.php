...
class MedalsController extends Controller
{
    public function index()
    {
        ...
        $filter = in_array($_GET['filter'] ?? '', ['automatic', 'manual', 'active', 'inactive'], true) ? $_GET['filter'] : '';
