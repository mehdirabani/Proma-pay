...
class Ecommerce extends Model
{
    ...
    public static function ensureSchema()
    {
        ...
        SchemaGuard::requireColumns('ecommerce_products', ['title', 'slug', 'sku', 'category', 'brand', 'price', 'sale_price', 'stock_quantity', 'short_description', 'description', 'image_path', 'status', 'is_featured', 'created_by', 'created_at', 'updated_at']);
        SchemaGuard::requireColumns('ecommerce_orders', ['order_number', 'customer_id', 'full_name', 'mobile', 'email', 'address', 'payment_method', 'payment_status', 'order_status', 'subtotal_amount', 'total_amount', 'notes', 'created_at', 'updated_at']);
        SchemaGuard::requireColumns('ecommerce_order_items', ['order_id', 'product_id', 'product_title', 'product_sku', 'quantity', 'unit_price', 'total_price', 'created_at']);
        SchemaGuard::requireColumns('ecommerce_installment_requests', ['customer_id', 'product_id', 'full_name', 'mobile', 'product_needed', 'notes', 'review_note', 'reviewed_by', 'reviewed_at', 'status', 'created_at', 'updated_at']);
