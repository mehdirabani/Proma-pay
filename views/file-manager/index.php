        ...
        <?php foreach (($filesPage['items'] ?? []) as $file): ?>
          ...
          <tr>
            ...
            <td><div class="proma-table-actions">
              <?php if ($file['status'] !== 'deleted'): ?><a class="proma-icon-button" href="<?= e(url('file-manager/view/' . $uuid)) ?>" target="_blank" rel="noopener" aria-label="مشاهده <?= e($file['display_name']) ?>" title="مشاهده سند"><?= proma_icon('eye') ?></a><?php endif; ?>
