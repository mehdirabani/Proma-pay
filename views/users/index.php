...
<section class="card">
  <div class="card-header card-no-border">
    <div class="header-top">
      <h2>فهرست کاربران</h2>
      <button class="btn" type="button" data-open-modal="create-user">افزودن کاربر</button>
    </div>
  </div>
  <div class="card-body">
    ...
    <table>
      ...
      <?php foreach ($users as $item): ?>
        <tr>
          ...
          <td class="actions"><button class="btn small secondary" type="button" data-open-modal="edit-user-<?= (int) $item['id'] ?>">ویرایش</button></td>
        </tr>
      <?php endforeach; ?>
