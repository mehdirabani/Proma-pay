    ...
    <div class="modal-content proma-modal-lg">
      ...
      <form method="post" action="<?= e(url('legal/storeAttachment/' . (int) ($case['id'] ?? 0))) ?>" enctype="multipart/form-data">
        <div class="modal-body form-grid">
          ...
          <label>تاریخ ثبت<input name="action_date" required value="<?= e(jdate(date('Y-m-d'))) ?>"></label>
...
<div class="grid cols-2">
  ...
  <section class="card">
    ...
    <div class="table-wrap">
      <table>
        <thead><tr><th>قسط</th><th>سررسید</th><th>مبلغ</th><th>پرداخت‌شده</th><th>وضعیت</th></tr></thead>
        <tbody>
        ...
        <?php endforeach; ?>
        <?php if (!$installments): ?><tr><td colspan="5" class="empty">قسطی برای این قرارداد ثبت نشده است.</td></tr><?php endif; ?>
        </tbody>
      </table>
    </div>
  </section>
